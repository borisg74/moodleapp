...
export class CoreConfigConstants {
    ...
    static versioncode = 3810;
    static versionname = '3.8.1-dev';
    ...
    static siteurl = 'https://e-learn2.rsu.edu.ru/moodle2';
    static sitename = '';
    ...
    static compilationtime = 1584690621096;
    static lastcommit = '2e81f534a4c2900b6cece77191b5348b28c71b27';
}
